classdef ElasticForceSystem < matlab.System
    % ElasticForceSystem Implements the computation of the elastic force.
    %
    ...
    methods
        function obj = ElasticForceSystem(varargin)
    ...
    methods(Access = protected)
        ...
        function validateInputsImpl(~, q)
            ...
            validateattributes(q, {'single','double'},{'vector'}, 'ElasticForceSystem','Configuration');
        end
