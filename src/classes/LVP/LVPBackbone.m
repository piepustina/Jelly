classdef LVPBackbone < Body
    ...
    methods (Static)
        ...
        function obj = loadobj(S)
            ...
            obj = LVPBackbone(S.RestLength, S.NGaussPoints, Primitives, S.Points);
    ...
    methods
        ...
        function Update(obj, q, dq, ddq)
            ...
            % TODO: The below code does not work, it is replaced temporarly with the z3 position, which is correct only if the stretch and compression primitive is the first one used.
            % for i = 1:obj.NGaussPointsInt
            ...
            obj.ElongationGauss     = reshape(obj.gGauss(3, 4, :), 1, []) - obj.GaussPoints;
            obj.JElongationGauss    = reshape(obj.JEtaGauss(6, :, :), obj.n, obj.NGaussPointsInt);
            obj.dElongationGauss    = reshape(obj.EtaGauss(6, :), 1, []);
            obj.ddElongationGauss   = reshape(obj.dEtaGauss(6, :), 1, []);
