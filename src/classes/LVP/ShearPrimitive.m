classdef ShearPrimitive < LVPPrimitive & BackbonePrimitive
    %Class modeling a shear primitive
    
    methods
        % Class constructor
        function obj = ShearPrimitive(Parameters)
        ...
        function [J, dJ] = StrainBasis(obj, s)
            ...
            [J(4:5, 1:obj.n), dJ(4:5, 1:obj.n)] = obj.PrimitiveBasis(s);
        end
