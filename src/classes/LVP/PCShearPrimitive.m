classdef PCShearPrimitive < ShearPrimitive
    %Piecewise constant shear primitive.
    ...
    methods
        function obj = PCShearPrimitive(BodyRestLength)
            %Construct an instance of the piecewise constant stretch and compression primitive.

            % Call the superclass
            obj = obj@ShearPrimitive({BodyRestLength});
