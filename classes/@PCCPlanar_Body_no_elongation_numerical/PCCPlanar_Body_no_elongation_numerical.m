classdef PCCPlanar_Body_no_elongation_numerical < Body
    
    properties(Constant)
        Type = "PCC_planar_no_elongation_numerical";
        n    = 1;
    end
    ...
    methods
        function obj = PCCPlanar_Body_no_elongation_numerical(Parameters)
            if isrow(Parameters)
                Parameters = Parameters';
            end
            obj = obj@Body(PCCPlanar_Body_no_elongation_numerical.n);
