classdef PCCPlanar_Joint_no_elongation_Gamma < Joint
    %PCC_PLANAR_SLENDER_NO_ELONGATION_JOINT

    properties(Constant)
        Type  = "PCCPlanar_Joint_no_elongation_Gamma";
        n = 1;
    end
    ...
    methods
        function obj = PCCPlanar_Joint_no_elongation_Gamma(L_0)
            obj = obj@Joint(PCCPlanar_Joint_no_elongation_Gamma.n);
            obj.Parameters = L_0;
        end
    end
end
