classdef PACCylindrical_Delta_Body < Body
    %PACCYLINDRICAL_Delta_BODY Defines a linear isotropic PAC body with elongation.
    ...
    methods
        function obj = PACCylindrical_Delta_Body(Parameters)
            if isrow(Parameters)
                Parameters = Parameters';
            end
            obj = obj@Body(PACCylindrical_Delta_Body.n);
