classdef PCCPlanar_Joint_no_elongation_numerical < Joint
    %PCC_PLANAR_SLENDER_NO_ELONGATION_JOINT

    properties(Constant)
        Type  = "PCCPlanar_Joint_no_elongation_numerical";
        n = 1;
    end
    ...
    methods
        function obj = PCCPlanar_Joint_no_elongation_numerical(L_0)
            obj = obj@Joint(PCCPlanar_Joint_no_elongation_numerical.n);
            obj.Parameters = L_0;
        end
    end
end
