classdef PCCPlanar_Body_no_elongation_Gamma < Body
    
    properties(Constant)
        Type = "PCC_planar_no_elongation_Gamma";
        n    = 1;
    end
    ...
    methods
        function obj = PCCPlanar_Body_no_elongation_Gamma(Parameters)
            if isrow(Parameters)
                Parameters = Parameters';
            end
            obj = obj@Body(PCCPlanar_Body_no_elongation_Gamma.n);
